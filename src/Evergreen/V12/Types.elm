...
type alias AdminPageModel =
    { logs : List Evergreen.V12.Logger.LogEntry
...
type LoginState
    ...
    | NotLogged Bool
    | LoginTokenSent
    | LoggedIn Evergreen.V12.Auth.Common.UserInfo
...
type alias FrontendModel =
    ...
    , authFlow : Evergreen.V12.Auth.Common.Flow
...
type alias BackendModel =
    { logState : Evergreen.V12.Logger.LogState
    , pendingAuths : Dict.Dict Lamdera.SessionId Evergreen.V12.Auth.Common.PendingAuth
    , sessions : Dict.Dict Lamdera.SessionId Evergreen.V12.Auth.Common.UserInfo
...
type ToBackend
    ...
    | AuthToBackend Evergreen.V12.Auth.Common.ToBackend
...
type BackendMsg
    = NoOpBackendMsg
    | GotLogTime Evergreen.V12.Logger.Msg
    | GotRemoteModel (Result Http.Error BackendModel)
    | AuthBackendMsg Evergreen.V12.Auth.Common.BackendMsg
...
type ToFrontend
    = A0 String
    | Admin_Logs_ToFrontend (List Evergreen.V12.Logger.LogEntry)
    | AuthSuccess Evergreen.V12.Auth.Common.UserInfo
    | AuthToFrontend Evergreen.V12.Auth.Common.ToFrontend
    | NoOpToFrontend
    | PermissionDenied ToBackend
    | UserDataToFrontend UserFrontend
    | UserInfoMsg (Maybe Evergreen.V12.Auth.Common.UserInfo)
